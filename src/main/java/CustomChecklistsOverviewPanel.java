...
public class CustomChecklistsOverviewPanel extends JPanel {
    ...
    private void initialize() {
        ...
        newChecklistField.setToolTipText("Enter checklist name");
        newChecklistField.addActionListener(e -> createNewChecklists());
        
        createButton = new JButton("Create Checklist");
        createButton.addActionListener(e -> createNewChecklists());
        createButton.setToolTipText("Create a new checklist");
    ...
    private void createNewChecklists() {
        ...
        String name = TaskManager.validateInputWithError(rawName.trim(), "Checklist name");
        if (name == null) {
            return; // Error already shown by validateInputWithError
        }
